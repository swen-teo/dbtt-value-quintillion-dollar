import svgPaths from "./svg-bm02d4ap6p";
...
function Heading() {
  return (
    <div className="content-stretch flex h-[36px] items-start relative shrink-0 w-full" data-name="Heading 2">
      <p className="flex-[1_0_0] font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[36px] min-h-px min-w-px not-italic relative text-[#101828] text-[30px] text-center tracking-[0.3955px]">Account sign up</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[255.39px] not-italic text-[#4a5565] text-[14px] text-center top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Step 1 of 3</p>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[28px] left-0 not-italic text-[#101828] text-[18px] top-0 tracking-[-0.4395px] whitespace-nowrap">Account Details</p>
    </div>
  );
}
...
function EmailInput() {
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[38px] relative rounded-[8px] shrink-0 w-full" data-name="Email Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[8px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(16,24,40,0.5)] tracking-[-0.1504px] whitespace-nowrap">Business Email</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" />
    </div>
  );
}
...
function PasswordInput() {
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[38px] relative rounded-[8px] shrink-0 w-full" data-name="Password Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[8px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(16,24,40,0.5)] tracking-[-0.1504px] whitespace-nowrap">Password</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" />
    </div>
...
function Button() {
  return (
    <div className="bg-[#ff6900] h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="Button">
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[254.52px] not-italic text-[16px] text-center text-white top-[7.5px] tracking-[-0.3125px] whitespace-nowrap">Next Step</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[32px] h-[354px] items-start left-[700px] pb-px pt-[33px] px-[33px] rounded-[14px] top-[152px] w-[576px]" data-name="Container">
...
function MaterialSymbolsHelpOutline() {
  return (
    <div className="absolute left-[700px] size-[24px] top-[115px]" data-name="material-symbols:help-outline">
...
function Help() {
  return (
    <div className="absolute contents left-[700px] top-[115px]" data-name="help">
      <MaterialSymbolsHelpOutline />
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold inset-[18.95%_42.36%_78.34%_51.93%] leading-[normal] not-italic text-[#27286f] text-[14px] tracking-[-0.1504px] whitespace-nowrap">Help Centre</p>
    </div>
  );
}
...
export default function Register() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="/register">
      <Header />
      <PublicLayout />
    </div>
  );
