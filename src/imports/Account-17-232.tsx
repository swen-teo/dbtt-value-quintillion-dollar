import svgPaths from "./svg-exxmlmksx8";
...
function Link3() {
  return (
    <div className="bg-[#fff4ed] h-[40px] relative rounded-[4px] shrink-0 w-full" data-name="Link">
      <div aria-hidden="true" className="absolute border border-[#f60] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-[8px] not-italic text-[#d08700] text-[16px] top-[7.5px] tracking-[-0.3125px] whitespace-nowrap">Order History</p>
    </div>
  );
}
...
function Link4() {
  return (
    <div className="h-[64px] relative rounded-[4px] shrink-0 w-full" data-name="Link">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[8px] not-italic text-[#4a5565] text-[16px] top-[7.5px] tracking-[-0.3125px] w-[96px]">{`B2B Credit & BNPL`}</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[403px] items-start left-0 pl-[24px] pr-[25px] pt-[24px] top-0 w-[194.25px]" data-name="Container">
...
function Heading1() {
  return (
    <div className="h-[37px] relative shrink-0 w-full" data-name="Heading 2">
      ...
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#0a0a0a] text-[20px] top-0 tracking-[-0.4492px] whitespace-nowrap">Order History</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#0a0a0a] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Order #INV-29031</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#6a7282] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">March 19, 2026</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="h-[48px] relative shrink-0 w-[143.102px]" data-name="Container">
...
function Paragraph8() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="-translate-x-full absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-[78.74px] not-italic text-[#0a0a0a] text-[16px] text-right top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">$404.80</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="bg-[#dcfce7] h-[22px] relative rounded-[16777200px] shrink-0 w-full" data-name="Text">
      <div className="content-stretch flex items-start px-[8px] py-[4px] relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#016630] text-[12px] text-right whitespace-nowrap">Completed</p>
      </div>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="h-[48px] relative shrink-0 w-[77.836px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[2.5px] items-start relative size-full">
        <Paragraph8 />
        <Text1 />
      </div>
    </div>
...
function Heading3() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#0a0a0a] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Order #INV-29032</p>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#6a7282] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">March 18, 2026</p>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="h-[48px] relative shrink-0 w-[145.203px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Heading3 />
        <Paragraph9 />
      </div>
...
function Heading4() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#0a0a0a] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Order #INV-29033</p>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#6a7282] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">March 17, 2026</p>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="h-[48px] relative shrink-0 w-[145.617px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Heading4 />
        <Paragraph11 />
      </div>
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[403px] items-start left-[194.25px] pt-[32px] px-[32px] top-0 w-[582.75px]" data-name="Container">
      <Heading1 />
      <Container12 />
    </div>
  );
...
function Container9() {
  return (
    <div className="h-[403px] relative shrink-0 w-full" data-name="Container">
      <Container10 />
      <Container11 />
    </div>
  );
...
function Container8() {
  return (
    <div className="bg-white h-[405px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
...
function Account1() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[461px] items-start relative shrink-0 w-full" data-name="Account">
      <Heading />
      <Container8 />
    </div>
  );
