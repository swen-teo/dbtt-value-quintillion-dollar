import svgPaths from "./svg-99hop50i38";
...
function Container14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Font_Awesome_5_Free:Solid','Noto_Sans:Black',sans-serif] justify-center leading-[0] relative shrink-0 text-[#10b981] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 900" }}>
...
function Container60() {
  return (
    <div className="content-stretch flex flex-col items-center min-w-[36px] relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Font_Awesome_5_Free:Solid','Noto_Sans:Black',sans-serif] justify-center leading-[0] relative shrink-0 text-[#f26522] text-[32px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 900" }}>
