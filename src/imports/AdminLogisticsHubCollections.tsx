import svgPaths from "./svg-pddgtg67p";
  ...
  return (
    <div className="h-[34px] relative shrink-0 w-[117.672px]" data-name="Link">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#333] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Hub Collections</p>
      </div>
    </div>
  );
}
...
function Link1() {
  return (
    <div className="h-[34px] relative shrink-0 w-[134.375px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[16px] text-white top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Heartland Routing</p>
      </div>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[27px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[27px] left-0 not-italic text-[#1f2937] text-[18px] top-[0.5px] tracking-[-0.4395px] whitespace-nowrap">{`Pick & Pack Queue (Pioneer Road HQ)`}</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[185.117px]" data-name="Heading 4">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#1f2937] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Order #INV-29031</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="absolute h-[20px] left-0 top-[24px] w-[185.117px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#99a1af] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Mama Shop #493 • 50 items</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[16px] left-0 top-[48px] w-[185.117px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px whitespace-nowrap">Ordered 25 minutes ago</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="h-[64px] relative shrink-0 w-[185.117px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Heading2 />
        <Paragraph />
        <Paragraph1 />
...
function Button() {
  return (
    <div className="bg-[#ff6900] flex-[1_0_0] h-[36px] min-h-px min-w-px relative rounded-[8px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[20px] left-[61.5px] not-italic text-[14px] text-center text-white top-[8.5px] tracking-[-0.1504px] whitespace-nowrap">Start Picking</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="h-[36px] relative shrink-0 w-[121.125px]" data-name="Container">
...
function Container4() {
  return (
    <div className="bg-white h-[98px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
...
function Heading3() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[185.117px]" data-name="Heading 4">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#1f2937] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Order #INV-29032</p>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[185.117px]" data-name="Heading 4">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#1f2937] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Order #INV-29033</p>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[185.117px]" data-name="Heading 4">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#1f2937] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Order #INV-29034</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[483px] items-start left-[25px] top-[92px] w-[729px]" data-name="Container">
      <Heading1 />
      <Container4 />
      <Container7 />
      <Container10 />
...
function Container1() {
  return (
    <div className="bg-white h-[600px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
...
export default function AdminLogisticsHubCollections() {
  return (
    <div className="bg-[#e6e6e6] relative size-full" data-name="/admin/logistics/hub-collections">
      <MainContent />
      <Sidebar />
    </div>
  );
