import svgPaths from "./svg-3l4twtdgil";
...
function Link2() {
  return (
    <div className="bg-[#fff4ed] h-[64px] relative rounded-[4px] shrink-0 w-full" data-name="Link">
      ...
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-[8px] not-italic text-[#d08700] text-[16px] top-[7.5px] tracking-[-0.3125px] w-[100px]">Subscription (Prime)</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[328px] items-start left-0 pl-[24px] pr-[25px] pt-[24px] top-0 w-[194.25px]" data-name="Container">
...
function Heading1() {
  return (
    <div className="h-[37px] relative shrink-0 w-full" data-name="Heading 2">
      ...
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#0a0a0a] text-[20px] top-0 tracking-[-0.4492px] whitespace-nowrap">Valu$ Trade Prime Subscription</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#733e0a] text-[18px] top-0 tracking-[-0.4395px] whitespace-nowrap">Active Prime Member</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a65f00] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Next billing date: April 20, 2026</p>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="h-[52px] relative shrink-0 w-[203.852px]" data-name="Container">
...
function Icon6() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Icon">
          <path d={svgPaths.p3c76d900} id="Vector" stroke="var(--stroke-0, #F0B100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container13() {
  return (
    <div className="absolute content-stretch flex h-[52px] items-center justify-between left-[25px] top-[25px] w-[468.75px]" data-name="Container">
      <Container14 />
      <Icon6 />
    </div>
  );
...
function Button4() {
  return (
    <div className="absolute bg-[#fb2c36] h-[36px] left-[25px] rounded-[8px] top-[93px] w-[164.648px]" data-name="Button">
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[82px] not-italic text-[14px] text-center text-white top-[8.5px] tracking-[-0.1504px] whitespace-nowrap">Cancel Subscription</p>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="bg-[#fff4ed] h-[154px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#f60] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <Container13 />
      <Button4 />
    </div>
  );
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[328px] items-start left-[194.25px] pt-[32px] px-[32px] top-0 w-[582.75px]" data-name="Container">
      <Heading1 />
      <Container12 />
    </div>
  );
...
function Container8() {
  return (
    <div className="bg-white h-[330px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
...
function Account1() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[386px] items-start relative shrink-0 w-full" data-name="Account">
      <Heading />
      <Container8 />
    </div>
  );
